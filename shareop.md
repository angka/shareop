...
| Database | SQLite (via `sql.js` di Node.js) — ringan, tanpa server terpisah |
...
## ATURAN SUASANA
SUASANA DIISI:
- 'pagi': jika lokal time menunjukan 06.00 - 11.59
- 'siang': jika lokal time menunjukan 12.00 - 14.59
- 'sore' : jika lokal time menunjukan 15.00 - 17.59
- 'malam' : jika lokal time menunjukan 18.00 - 05.59
...
- terdapat scroll bar horizontal dan vertikal
- jarak antar row jangan terlalu lebar
- pada bagian jam menggunakan format 24 jam contoh 15.30, tidak menggunakan am/pm
